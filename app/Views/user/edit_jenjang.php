...
<?= $this->section('content') ?>
            ...
            <div class="card-body">
              ...
              <form action="" method="post">
                ...
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="mendapat_kerja" id="mendapat_kerja1" value="Ya" <?= $jenjang['mendapat_kerja'] == 'Ya' ? 'checked' : ''; ?>>
                      <label class="form-check-label" for="mendapat_kerja1">
                        Ya
                      </label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="mendapat_kerja" id="mendapat_kerja2" value="Tidak" <?= $jenjang['mendapat_kerja'] == 'Tidak' ? 'checked' : ''; ?>>
                ...
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="berapa_bulan" value="<?= $jenjang['berapa_bulan']; ?>" name="berapa_bulan">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="pendapatan_kotor" name="pendapatan_kotor" value="<?= $jenjang['pendapatan_kotor']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  <label for="lokasi_bekerja" class="col-12 col-sm-12 col-md-4 col-form-label">Dimana lokasi tempat Anda bekerja?</label>
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="lokasi_bekerja" name="lokasi_bekerja" value="<?= $jenjang['lokasi_bekerja']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                ...
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="institusi" name="institusi" value="<?= $jenjang['institusi']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  <label for="nama_atasan" class="col-12 col-sm-12 col-md-4 col-form-label">Siapa nama atasan di tempat Anda bekerja?</label>
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="nama_atasan" name="nama_atasan" value="<?= $jenjang['nama_atasan']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  <label for="no_hp_atasan" class="col-12 col-sm-12 col-md-4 col-form-label">Nomor HP atasan di tempat Anda bekerja</label>
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="tel" class="form-control" id="no_hp_atasan" name="no_hp_atasan" value="<?= $jenjang['no_hp_atasan']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  <label for="email_atasan" class="col-12 col-sm-12 col-md-4 col-form-label">Alamat email atasan di tempat Anda bekerja</label>
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="email" class="form-control" id="email_atasan" name="email_atasan" value="<?= $jenjang['email_atasan']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="posisi" name="posisi" value="<?= $jenjang['posisi']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  <label for="tingkat" class="col-12 col-sm-12 col-md-4 col-form-label">Apa tingkat tempat kerja Anda?</label>
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="tingkat" name="tingkat" value="<?= $jenjang['tingkat']; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="perguruan_tinggi" name="perguruan_tinggi" value="<?= $jenjang['perguruan_tinggi']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  <label for="prodi" class="col-12 col-sm-12 col-md-4 col-form-label">Program Studi :</label>
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="prodi" name="prodi" value="<?= $jenjang['prodi']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  <label for="sejak" class="col-12 col-sm-12 col-md-4 col-form-label">Tanggal Masuk</label>
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="date" class="form-control" id="sejak" name="sejak" value="<?= $jenjang['sejak']; ?>">
                  </div>
                </div>      
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="sumber_dana_saat_kuliah" name="sumber_dana_saat_kuliah" value="<?= $jenjang['sumber_dana_saat_kuliah']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="hubungan_studi" name="hubungan_studi" value="<?= $jenjang['hubungan_studi']; ?>">
                  </div>
                </div>
                <div class="row mb-3 justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="text" class="form-control" id="kesesuaian_pendidikan" name="kesesuaian_pendidikan" value="<?= $jenjang['kesesuaian_pendidikan']; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="etika_lulus" name="etika_lulus" value="<?= $jenjang['etika_lulus']; ?>">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="keahlian_lulus" name="keahlian_lulus" value="<?= $jenjang['keahlian_lulus']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="inggris_lulus" name="inggris_lulus" value="<?= $jenjang['inggris_lulus']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="teknologi_lulus" name="teknologi_lulus" value="<?= $jenjang['teknologi_lulus']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="komunikasi_lulus" name="komunikasi_lulus" value="<?= $jenjang['komunikasi_lulus']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="kerja_lulus" name="kerja_lulus" value="<?= $jenjang['kerja_lulus']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="pengembangan_lulus" name="pengembangan_lulus" value="<?= $jenjang['pengembangan_lulus']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="etika_kerja" name="etika_kerja" value="<?= $jenjang['etika_kerja']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="keahlian_kerja" name="keahlian_kerja" value="<?= $jenjang['keahlian_kerja']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="inggris_kerja" name="inggris_kerja" value="<?= $jenjang['inggris_kerja']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="teknologi_kerja" name="teknologi_kerja" value="<?= $jenjang['teknologi_kerja']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="komunikasi_kerja" name="komunikasi_kerja" value="<?= $jenjang['komunikasi_kerja']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="kerja_kerja" name="kerja_kerja" value="<?= $jenjang['kerja_kerja']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
                ...
                <div class="row mb-3 justify-content-center align-items-start">
                  ...
                  <div class="col-12 col-sm-12 col-md-8">
                    <input type="range" class="form-range" min="1" max="5" id="pengembangan_kerja" name="pengembangan_kerja" value="<?= $jenjang['pengembangan_kerja']; ?>">
                    <div class="row d-flex justify-content-between mb-3">
                        <div class="col-2 col-sm-2 col-md-2">
  ...
  <script>
    ...
    status.value =  "<?= $jenjang['status']; ?>";
    const jenis_instansi = document.getElementById('jenis_institusi');
    jenis_instansi.value = "<?= $jenjang['jenis_institusi']; ?>";
    const sumber_biaya = document.getElementById('sumber_biaya');
    sumber_biaya.value = "<?= $jenjang['sumber_biaya']; ?>";
  </script>
  <?= $this->endSection() ?>
