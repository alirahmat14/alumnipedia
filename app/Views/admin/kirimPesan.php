    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Kirim Pesan untuk User</h5>
              ...
              <form action="" method="post">
                ...
                <div class="row mb-3">
                  <label for="penerima" class="col-12 col-sm-2 col-form-label">Pilih Penerima</label>
                  <div class="col-12 col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="penerima" name="penerima" required>
                        <option selected disabled>Lihat daftar pengguna</option>
                        <?php foreach($daftar_user as $du): ?>
                            <option value="<?= $du['id_user']; ?>"><?= $du['username'].' - '.$du['nama']; ?></option>
                        <?php endforeach; ?>
                    </select>
                  </div>
                </div>
